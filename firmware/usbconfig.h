...
#define  USB_CFG_VENDOR_ID       0xc0, 0x16 /* obdev's shared VID for HIDs */
//#define  USB_CFG_VENDOR_ID       0x6a, 0x04 /* Cherry GmbH */
/* USB vendor ID for the device, low byte first. If you have registered your
 * own Vendor ID, define it here. Otherwise you use one of obdev's free shared
 * VID/PID pairs. Be sure to read USBID-License.txt for rules!
 */
#define  USB_CFG_DEVICE_ID       0xdf, 0x05 /* obdev's shared PID for HIDs */
//#define  USB_CFG_DEVICE_ID       0x06, 0x01 /* wired keyboard */
 ...
 */
//#define USB_CFG_VENDOR_NAME     'k', 'l', 'a', 'u', 't', 'e', '\'', 's'
 ...
 * details.
 */
//#define USB_CFG_DEVICE_NAME     'H', 'a', 'c', 'k', 'S', 't', 'i', 'c', 'k'
